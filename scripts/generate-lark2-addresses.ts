...
async function main() {
  const deployments = "deployments/lark2";
  ...
  fs.writeFileSync("GIGAHDX-LARK2-ADDRESSES.json", JSON.stringify(out, null, 2));
  console.log("wrote GIGAHDX-LARK2-ADDRESSES.json");
...
`;
  ...
  fs.writeFileSync("GIGAHDX-LARK2-ADDRESSES.md", md);
  console.log("wrote GIGAHDX-LARK2-ADDRESSES.md");
}
