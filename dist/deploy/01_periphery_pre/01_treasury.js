...
const func = async function ({ getNamedAccounts, deployments, ...hre }) {
    ...
    await (0, helpers_1.waitForTx)(await proxy["initialize(address,address,bytes)"](treasuryImplArtifact.address, treasuryOwner, initializePayload, { gasLimit: 1000000 }));
    return true;
};
