...
const getAlchemyKey = (net) => {
    switch (net) {
        ...
        case types_1.eEthereumNetwork.sepolia:
            return process.env.SEPOLIA_ALCHEMY_KEY || exports.ALCHEMY_KEY;
        case types_1.eBaseNetwork.base:
            return process.env.BASE_ALCHEMY_KEY || exports.ALCHEMY_KEY;
        default:
...
exports.NETWORKS_RPC_URL = {
    ...
    [types_1.eEthereumNetwork.sepolia]: `https://eth-sepolia.g.alchemy.com/v2/${(0, exports.getAlchemyKey)(types_1.eEthereumNetwork.sepolia)}`,
    [types_1.eArbitrumNetwork.goerliNitro]: `https://goerli-rollup.arbitrum.io/rpc`,
    [types_1.eBaseNetwork.baseGoerli]: `https://goerli.base.org`,
    [types_1.eBaseNetwork.base]: `https://base-mainnet.g.alchemy.com/v2/${(0, exports.getAlchemyKey)(types_1.eBaseNetwork.base)}`,
    [types_1.eHydrationNetwork.nice]: "https://rpc.nice.hydration.cloud",
    [types_1.eHydrationNetwork.hydration]: "https://rpc.hydradx.cloud",
    [types_1.eHydrationNetwork.zombie]: "http://localhost:8645",
};
exports.LIVE_NETWORKS = {
    ...
    [types_1.eHydrationNetwork.hydration]: true,
    [types_1.eHydrationNetwork.nice]: true,
    [types_1.eBaseNetwork.base]: true,
};
const GAS_PRICE_PER_NET = {
    [types_1.eArbitrumNetwork.goerliNitro]: 100000001,
    [types_1.eBaseNetwork.baseGoerli]: 8000000000,
};
