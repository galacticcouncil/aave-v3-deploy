...
exports.MOCK_CHAINLINK_AGGREGATORS_PRICES = {
    ...
    CBETH: (0, utils_1.parseUnits)("4000", 8).toString(),
    DOT: (0, utils_1.parseUnits)("10", 8).toString(),
    VDOT: (0, utils_1.parseUnits)("10", 8).toString(),
};
exports.chainlinkAggregatorProxy = {
    ...
    [types_1.eEthereumNetwork.sepolia]: "0x6c60d915c7a646860dba836ffcb7f112b6cfdc76",
    [types_1.eHydrationNetwork.hydration]: "0x8aEAE0bBf623B0E70732086B8D48A6090C311596",
    [types_1.eHydrationNetwork.nice]: "0xBd763043861CAF4E7e4E7Ffe951A03dF2Ea7E5AC",
};
...
exports.HYDRATION_TEST_ADMIN = "0x52341e77341788Ebda44C8BcB4C8BD1B1913B204";
exports.POOL_ADMIN = {
    ...
    [types_1.eBaseNetwork.base]: "0xA9F30e6ED4098e9439B2ac8aEA2d3fc26BcEbb45",
    [types_1.eBaseNetwork.baseGoerli]: "0xA9F30e6ED4098e9439B2ac8aEA2d3fc26BcEbb45",
    [types_1.eEthereumNetwork.tenderly]: exports.ETHEREUM_SHORT_EXECUTOR,
    [types_1.eHydrationNetwork.hydration]: "0xaa7e0000000000000000000000000000000aa7e0",
    [types_1.eHydrationNetwork.nice]: exports.HYDRATION_TEST_ADMIN,
    [types_1.eHydrationNetwork.zombie]: exports.HYDRATION_TEST_ADMIN,
};
exports.EMERGENCY_ADMIN = {
    ...
    [types_1.eEthereumNetwork.main]: exports.ETHEREUM_SHORT_EXECUTOR,
    [types_1.eHydrationNetwork.hydration]: "0x146a5e57fa0b8b1e13c53bcf1d05183b1c02b51b",
    [types_1.eHydrationNetwork.nice]: "0xb847e0fd2a5e62d621a0382419bddb0a351a6d9c",
    [types_1.eHydrationNetwork.zombie]: exports.HYDRATION_TEST_ADMIN,
};
...
exports.GOVERNANCE_BRIDGE_EXECUTOR = {
    [types_1.ePolygonNetwork.polygon]: "0xdc9A35B16DB4e126cFeDC41322b3a36454B1F772",
    [types_1.eOptimismNetwork.main]: "0x7d9103572bE58FfE99dc390E8246f02dcAe6f611",
    [types_1.eArbitrumNetwork.arbitrum]: "0x7d9103572bE58FfE99dc390E8246f02dcAe6f611",
};
exports.MULTISIG_ADDRESS = {
    ...
    // Polygon Multisig
    [types_1.ePolygonNetwork.polygon]: "0x1450F2898D6bA2710C98BE9CAF3041330eD5ae58",
    [types_1.eHydrationNetwork.hydration]: "0xaa7e1000000000000000000000000000000aa7e10",
    [types_1.eHydrationNetwork.nice]: exports.HYDRATION_TEST_ADMIN,
    [types_1.eHydrationNetwork.zombie]: exports.HYDRATION_TEST_ADMIN,
};
