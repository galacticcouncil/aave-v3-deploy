...
exports.default = {
    ...
    networks: {
        ...
        tenderly: (0, hardhat_config_helpers_1.getCommonNetworkConfig)("tenderly", 1),
        ...
        [types_1.eEthereumNetwork.sepolia]: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(types_1.eEthereumNetwork.sepolia, 11155111),
        ...
        [types_1.eHydrationNetwork.hydration]: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(types_1.eHydrationNetwork.hydration, 222222),
        [types_1.eHydrationNetwork.zombie]: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(types_1.eHydrationNetwork.zombie, 
        // 1287
        222222),
        [types_1.eHydrationNetwork.nice]: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(types_1.eHydrationNetwork.nice, 222222),
        [types_1.eBaseNetwork.base]: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(types_1.eBaseNetwork.base, 8453),
        [types_1.eBaseNetwork.baseGoerli]: (0, hardhat_config_helpers_1.getCommonNetworkConfig)(types_1.eBaseNetwork.baseGoerli, 84531),
    },
    namedAccounts: {
    ...
    etherscan: {
        apiKey: hardhat_config_helpers_1.ETHERSCAN_KEY || {
            [types_1.eHydrationNetwork.nice]: "nice",
            [types_1.eHydrationNetwork.hydration]: "hydration",
        },
        customChains: [
            {
                network: types_1.eBaseNetwork.base,
                chainId: 8453,
                urls: {
            ...
            {
                network: types_1.eHydrationNetwork.nice,
                chainId: 222222,
                urls: {
            ...
            {
                network: types_1.eHydrationNetwork.hydration,
                chainId: 222222,
                urls: {
