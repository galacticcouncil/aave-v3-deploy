...
(0, config_1.task)(`review-e-mode`, ``)
    ...
    .setAction(async ({ name, fix, batch }, hre) => {
    ...
    if (delta) {
        ...
        const tx = await poolConfigurator.populateTransaction.setEModeCategory(id, expectedCategory.ltv, expectedCategory.liquidationThreshold, expectedCategory.liquidationBonus, expectedCategory.priceSource, expectedCategory.label, { gasLimit: 300000 });
        if (batch) {
