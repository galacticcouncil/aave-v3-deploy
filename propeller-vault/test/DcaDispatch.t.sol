...
contract DcaDispatchTest is Test {
    ...
    bytes constant REFERENCE =
        hex"420000000000000000000000000000000000000000aa4554480000000000000000000a0000000000a0dec5adc93536000000000000000000011027000000de00000013040000000010632d5ec76b0500000000000000c09ee60500000000000000000000000008028f000000de0000002b000000042b0000001304000000";
    ...
    function test_ownerDerivation() public pure {
        // [20-byte addr][b"ETH\0"][8x00]
        assertEq(
            DcaDispatch.ownerOf(0x00000000000000000000000000000000000000AA),
            bytes32(hex"00000000000000000000000000000000000000aa4554480000000000000000"),
