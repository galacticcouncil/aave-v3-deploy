...
// Assets WITH USDOracleAdapter have different secondaryFeed
// Assets WITHOUT USDOracleAdapter have primaryFeed = secondaryFeed
const ORACLE_CONFIGS = [
  // === Assets WITH USDOracleAdapter (different secondary) ===
  {
    name: '2-POOL-GDOT',
...
async function main() {
  ...
  const deployedAddresses: Record<
    string,
    { address: string | null; primaryFeed: string; secondaryFeed: string }
  > = {}
